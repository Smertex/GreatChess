...
import org.example.Model.Figures.*;
...
public class BoardBuilder {
    public Figure[][] gameBoard(){
        ...
        Figure testFigure1 = new Giraffe(true, new Coordinate(4, 4));
        ...
        board = new Figure[][]{
                ...
                {null, null, null, null, null, null, null, null, null, null},
                {null, null, null, null, testFigure1, null, null, null, null, null},
                {null, null, null, null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, null, null, null},
    ...
    public Figure[][] testBoardForCheckMoveKing(){
        ...
        Figure rookW1 = new Rook(true, new Coordinate(4,8));
        Figure horseB1 = new Horse(false, new Coordinate(5, 1));
        Figure elephantB1 = new Elephant(false, new Coordinate(8, 8));
        Figure kingB = new King(false, new Coordinate(6,3));
        Figure pawnB = new Pawn(false, new Coordinate(3,2));

        board = new Figure[][]{
                {null, null, null, null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, null, null, null},
                {null, null, null, null, null, null, null, null, null, null},
                {null, null, pawnB, null, pawnW1, null, null, null, null, null},
                {null, null, null, kingW, null, null, null, null, rookW1, null},
                {null, horseB1, null, null, null, null, null, null, null, null},
